...
export interface NGNTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface NGNToken extends BaseContract {
  connect(runner?: ContractRunner | null): NGNToken;
  waitForDeployment(): Promise<this>;

  interface: NGNTokenInterface;
  ...
  burnAll: TypedContractMethod<[], [void], "nonpayable">;
